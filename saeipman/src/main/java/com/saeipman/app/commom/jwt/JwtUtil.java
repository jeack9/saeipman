 ...
 * // 토큰 발행, 검증
 * 
 * @Component public class JwtUtil { // username, role, 생성일, 만료일 private
 * SecretKey secretKey;
 * 
 * public JwtUtil(@Value("${spring.jwt.secret}") String secret) { secretKey =
 ...
 * Date(System.currentTimeMillis() + expiredMs)) .signWith(secretKey).compact();
 * } }
 */